...
import com.example.moneyminder.databinding.ActivityPanelControlAlarmaBinding

class PanelControlAlarma : AppCompatActivity(), OnClickListener {
    private lateinit var binding: ActivityPanelControlAlarmaBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        binding = ActivityPanelControlAlarmaBinding.inflate(layoutInflater)
